<template>
  <div class="max-w-screen mx-auto p-6 space-y-8">
    <h2 class="text-3xl pb-8 font-bold text-center text-blue-700">
...
// Import marker icons for Vite (important for production)
...
const drawMap = () => {
  ...
  stations.value.forEach(station => {
    ...
    marker.bindPopup(
      `<strong>${station.name}</strong><br>${station.status} | ${station.powerOutput}kW<br>Connector: ${station.connectorType}`
    )
